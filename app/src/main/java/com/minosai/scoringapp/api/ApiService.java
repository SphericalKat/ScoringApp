...
public interface ApiService {
    ...
    Call<EmployeePayload> registerEmployee(@Body RegisterRequestModel registerRequestModel);

    @POST("api/auth/login")
    Call<LoginPayload> loginEmployee(@Body LoginRequestModel loginRequestModel);

    @GET("api/employee/profile")
    Call<EmployeePayload> fetchEmployeeDetails();

    @GET("api/employee/groups")
    Call<GroupsPayload> fetchGroupsList();

    @GET("api/employee/events")
    Call<EventsPayload> fetchEventsList();

    @GET("api/employee/leaderboard")
    Call<LeaderboardPayload> fetchLeaderboard(@Query(value = "event_id") String eventId);
